...
We used the Python library \verb|beautifulsoup4| [4] to parse the HTML calendar file and
...
(using NetworkX [5]), and \verb|hierarchical_layout()| places courses at the same depth on
...
\begin{itemize}
    \item \verb|networkx| [5]: converts \verb|CourseGraph| to a \verb|nx.DiGraph| via
    ...
    \item \verb|beautifulsoup4| [4]: parses the HTML course calendar in \verb|parse.py|
...
\end{verbatim}
    \item Run the interactive interface:
\begin{verbatim}
python interface.py
\end{verbatim}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item[{[3a]}] Plotly Technologies Inc. ``Network Graphs in Python.'' \textit{Plotly},
    2025. Available at: \url{https://plotly.com/python/network-graphs/}. Accessed March 2026.

    \item[{[4]}] Richardson, L. ``Beautiful Soup Documentation.'' \textit{Crummy}, 2025.
    Available at: \url{https://www.crummy.com/software/BeautifulSoup/bs4/doc/}. Accessed
    March 2026.

    \item[{[5]}] Hagberg, A., Swart, P., and Chult, D.\ S. ``Exploring Network Structure,
